...
A TPP is a markdown file in `docs/` that persists research, design decisions, and
implementation progress across Claude Code sessions. When a session ends, `/handoff`
saves the current state. When a new session starts, `/pickup docs/YYYYMMDD-name.md`
...
- Move completed plans to `docs/_done/` for future reference
...
3. **Work on a TPP**: `/pickup docs/YYYYMMDD-feature.md`
4. **Before ending**: `Escape`, then `/handoff`
5. **Next session**: `/pickup docs/YYYYMMDD-feature.md` to continue
